                            ...
                            <div class="col-sm-3">
                                <div class="input-group input-group-sm mb-2">
                                  ...
                                  <select class="custom-select" id="cboventatipodocumento">
                                    <option value="Boleta">Vale</option>
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              ...
                                              <select class="form-control form-control-sm model" id="cboclientetipodocumento" name="Rol">
                                                  ...
                                                  <option value="Carnet Extranjeria">DPI</option>
                          ...
                          <div class="col-sm-6">
                              <div class="row">
                                  <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">Sub Total Q/.</label>
                                          </div>
                                  ...
                                  <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">IVA Q/.</label>
                                          </div>
                                  ...
                                  <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">Total Q/.</label>
                                          </div>
                          ...
                          <div class="col-sm-6">
                               <div class="row">
                                  <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">Monto Pago Q/.</label>
                                          </div>
                                  ...
                                  <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">Cambio Q/.</label>
                                          </div>
